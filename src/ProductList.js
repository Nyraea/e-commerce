...
const supplements = [
  ...
  const productItems = supplements.map(product => <Card brand={product.brand} name={product.productName} price={'$'+product.price} stock={product.availability} link={product.imageUrl} ></Card>);
